...
static void sendData(int fd_pipe_to_service, const char *chaine_a_envoyer)
{
    ...
    my_write(fd_pipe_to_service, &len, sizeof(int));
    my_write(fd_pipe_to_service, chaine_a_envoyer, sizeof(char) *len);
}
